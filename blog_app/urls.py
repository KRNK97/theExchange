...
# from . import views
from .views import HomeView, PostDetailView, AddPostView, EditPostView, DeletePostView, AddCategoryView, FilterView, FilterAuthorView, LikeView, CommentView, DeleteCommentView, aboutView
